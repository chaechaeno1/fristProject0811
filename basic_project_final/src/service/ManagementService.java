...
public class ManagementService {
	...
	public int adlogin() {
		...
		while (true) {
			...
			if (admin.get("AD_ID").equals(adIdInput) && admin.get("AD_PW").equals(adPwInput)) {
				System.out.println("관리자님이 로그인 되었습니다");
				System.out.println();
	...
	public int manageBus() {
		...
		System.out.println("==============================================================================");
		System.out.println("관리자메뉴를 선택해주세요.");
		System.out.println("	1. 버스 추가 | 2. 버스 삭제 | 3. 버스 수정 | 9.버스 목록 | 0.홈");
		System.out.println("==============================================================================");
		System.out.print(">>메뉴 번호 입력 : ");
		int SelectMenu = ScanUtil.nextInt();
		...
		if (SelectMenu == 1) {
			...
			System.out.println("버스등급은 프리미엄(p), 우등(u), 일반(n) 입니다 ");
			...
			if (busList == null) {
				System.out.println("수정할 버스가 없습니다.");
				return View.MANAGE_MENU;
			}
			...
			if (yn.equals("n") || yn.equals("N"))
				...
				int flag = dao.busUpdate(param);

				if (flag == 0)
					System.out.println("버스 수정에 실패하였습니다...");
				else
					System.out.println("버스 수정에 성공하였습니다.");
			} else
				System.out.println("잘못 입력 하셨습니다.");
	...
	public int manageStation() {
		...
		System.out.println("==============================================================================");
		System.out.println("관리자메뉴를 선택해주세요.");
		System.out.println("	1. 터미널 추가 | 2. 터미널 삭제 | 3. 터미널 수정 | 9.터미널 목록 | 0.홈");
		System.out.println("==============================================================================");
		System.out.print(">>메뉴 번호 입력 : ");
		int SelectMenu = ScanUtil.nextInt();
		...
		if (SelectMenu == 1) {
			...
			if (stsList == null) {
				System.out.println("수정할 터미널이 없습니다.");
				return View.MANAGE_MENU;
			}
			...
			System.out.print("수정할 터미널이름 >> ");
			String stsName = ScanUtil.nextLine();

			System.out.print("수정할 터미널 주소 >> ");
			String stsAdd = ScanUtil.nextLine();
			...
			if (yn.equals("n") || yn.equals("N")) {
				...
				int flag = dao.stationUpdate(param);

				if (flag == 0)
					System.out.println("터미널 수정 실패");
				else
					System.out.println("터미널 수정 성공");
			} else {
				System.out.println("잘못 입력 하셨습니다.");
				return View.MANAGE_STATION;
			}
	...
	public int serviceList() {
		...
		if (servicelist == null) {
			...
			System.out.println("==============================================================================");
			System.out.println("번호       운행ID             운행시간                       노선ID                  버스ID");
			System.out.println("==============================================================================");
