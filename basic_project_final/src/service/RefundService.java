...
public class RefundService {
	...
	public int refund() {
		...
		if (list == null) {
			...
			for (Map<String, Object> item : list) {
				...
				System.out.print(" : \t" + str.substring(2, 16));
	...
	public int refundTicket() {
		...
		if (yn.equals("y") || yn.equals("Y")) {
			...
			resparam.add(priceCalc.price(Integer.parseInt(String.valueOf(session.get(6))), (String) session.get(7),
					(String) session.get(8)));
